...
export const CalendarGrid: React.FC<CalendarGridProps> = ({ events, onDateClick, onEventClick }) => {
  ...
  return (
    <div className="h-full flex flex-col p-3 md:p-8">
      ...
      <div className="flex-1 grid grid-cols-7 grid-rows-5 gap-0.5 md:gap-2">
        {calendarDays.map((day, idx) => {
          ...
          return (
            <div 
              ...
              className={`
                relative p-1 md:p-2 rounded-lg md:rounded-xl border border-transparent transition-all cursor-pointer group flex flex-col
